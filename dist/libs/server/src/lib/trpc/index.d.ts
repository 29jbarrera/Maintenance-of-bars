...
export declare const appRouter: import("@trpc/server/dist/unstable-core-do-not-import").BuiltRouter<{
    ...
    admin: import("@trpc/server/dist/unstable-core-do-not-import").BuiltRouter<{
        ctx: {
            user: import("./utils/decoke-and-verify-token").JWTDecode | null;
        };
        meta: object;
    ...
    organizations: import("@trpc/server/dist/unstable-core-do-not-import").BuiltRouter<{
        ...
        get_letterhead: import("@trpc/server").TRPCMutationProcedure<{
            ...
            output: {
                letterhead: import("dist/libs/commons/src").LetterHead[];
            };
        }>;
        ...
        oidokocina: import("@trpc/server/dist/unstable-core-do-not-import").BuiltRouter<{
            ...
            get_pedidos: import("@trpc/server").TRPCMutationProcedure<{
                ...
                output: import("dist/libs/commons/src").OK_PEDIDOS;
            }>;
            get_un_pedido: import("@trpc/server").TRPCMutationProcedure<{
                ...
                output: import("dist/libs/commons/src").OK_PEDIDO_UNO;
            }>;
        }>;
