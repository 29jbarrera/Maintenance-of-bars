...
(async () => {
  ...
  const categories_should_had_modification = [
    'f5cb1296-2672-47d8-a5ed-6c0272a83d9e', // 'Whisky
    'ac7473e7-3dd5-41d1-a6a3-3197cfe12cbc', // 'GINEBRA
    '694f9304-6e6e-4061-9706-8dc3ee031e59', // 'RON
    '2ca53a9d-54b8-4357-b440-b34f45b7bb5e', // 'VOZKA
  ];
...
async function add_cosas() {
  ...
  const categories_to_add = [
    '3a14a975-2b91-49d7-a953-a4abe0fec4bd', // 'BEBIDAS 1
  ...
  console.log(
    'Añadiendo categorias a las categorias que deberian tener modificacion'
  );
  for (const category of categories_should_had_modification) {
    await prisma.product_category_has_other_product_category.createMany({
  ...
  //   'a54f3d8f-2c49-4fd6-ae9d-f156fef25c4e' // 'COMBINADOS
}
